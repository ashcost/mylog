...
MYSQL_DBNAME = os.getenv('MYSQL_DBNAME', 'newmedia_db')
MYSQL_USER = os.getenv('MYSQL_USER', 'root')
MYSQL_PASSWD = os.getenv('MYSQL_PASSWD', 'abc123')
MYSQL_PORT = int(os.getenv('MYSQL_PORT', 3306))

WEIBO_TOKEN = os.getenv('WEIBO_TOKEN', '2.00ZLWYdC0KWpTW73ca4f3acb4k45rD')
